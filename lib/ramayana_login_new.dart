                ...
                Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Center(child: Text('Welcome!', style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, fontStyle: FontStyle.normal, ),)),
                        ),
                         Container(
                          margin: EdgeInsets.only(top: 10),
                          child: Center(child: Text('Login to Continue', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500, fontStyle: FontStyle.normal, ),)),
                        ),
                        SizedBox(
                          height: 70,
                        ),
                  ...
                  children: <Widget>[
                    ...
                    MaterialButton(
                        ...
                        child: Text(
                          'Forget Password?',
                          style: TextStyle(color: Color.fromARGB(255, 152, 10, 0), fontSize: 19, fontWeight: FontWeight.bold),
                        ),
                        // color: Colors.red,
                        onPressed: () {
